...
const ProjectPage = ({ id }) => {
    ...
    return (
        <div className="bg-gray01 w-screen h-screen overflow-hidden">
            ...
            <div className="flex w-full h-full flex-col md:flex-row">
                ...
                <div className="w-full md:w-1/2 h-full bg-gray04">
                    <div className='w-full h-full flex justify-center items-center'>
                        <img src={project.image} alt="project_image" className='z-10 w-[80%] pt-12 sm:pt-16 max-w-xl rounded-lg hover:scale-110 hover:brightness-105 transition-all duration-300 shadow-[0px_50px_30px_-50px_rgba(0,0,0,.5)] hover:shadow-[0px_20px_30px_-50px_rgba(0,0,0,1)]' />
                    </div>
                </div>
