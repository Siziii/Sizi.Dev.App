...
const techIcons = [
        { name: 'Framer Motion', icon: <SiFramer size={32} className="transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
        { name: 'Blender', icon: <SiBlender size={32} className="transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
        { name: 'Substance Painter', icon: <img src={Painter} alt="Substance Painter" className="w-8 h-8 transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
        { name: 'Substance Designer', icon:  <img src={Designer} alt="Substance Designer" className="w-8 h-8 transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
        { name: 'Quixel Suite', icon: <img src={Quixel} alt="Quxiel Suite" className="w-8 h-8 transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
        { name: 'Unity 3D', icon: <BiLogoUnity size={32} className="transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
        ...
        { name: 'Photoshop', icon: <SiAdobephotoshop size={32} className="transition-all opacity-50 hover:opacity-100 hover:scale-110" />},
        ...
        { name: 'VS Code', icon: <SiVisualstudio size={32} className="transition-all opacity-50 hover:opacity-100 hover:scale-110" /> },
];
